(function (global, factory) {
	...
	var scene = (html => {
	  ...
	  const hasImage = el.querySelector('img'); // console.log(hasText, hasHeading, hasImage)
	  // regular text scene
	...
	var blocks = ['youtube', 'svg', 'video', 'vegalite', 'chartjs', 'fitty'];
	var block$2 = (src => {
	...
	var index = (str => {
	  ...
	  scenes.forEach(d => {
	    if (d !== '\n---\n') {
	      const text = d.trim();
	      const srcHtml = marked_1(text);
	      const blk = block$2(srcHtml);
	      ...
	      for (const p in props) {
	        scn[p] = props[p]; // scn.blocks.forEach(block => {
	        //   block[p] = props[p]
	        // })
	      }
